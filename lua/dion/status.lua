...
function M.hl.mode(base)
  local lualine_avail, lualine = pcall(require, "lualine.themes." .. (vim.g.colors_name or "dion"))
  return function()
  ...
  return function()
    ...
    for _, client in pairs(vim.lsp.buf_get_clients(0)) do
      if client.name == "null-ls" and expand_null_ls then
        vim.list_extend(buf_client_names, nvim.null_ls_sources(vim.bo.filetype, "FORMATTING"))
        vim.list_extend(buf_client_names, nvim.null_ls_sources(vim.bo.filetype, "DIAGNOSTICS"))
      else
